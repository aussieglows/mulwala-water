...
export const metadata: Metadata = {
  description:
    "We take an operating seat inside founder-led, sponsor-backed and multi-unit businesses, run the play, and hand it over. Big-company discipline, done by operators.",
