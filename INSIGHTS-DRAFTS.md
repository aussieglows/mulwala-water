# Insight article drafts — for Laura's review

All six are drafted and loaded into the site (`content/insights.ts`) but **unpublished** —
they won't appear on the live site until you approve them and give me a byline (whose name they
publish under). Read them here, mark up anything you'd change, and tell me the author name.

Voice notes: the answer is stated in the first paragraph (so AI answer engines can quote it),
understated operating tone, and **no invented client names, numbers, or quotes** — anything you'd
want backed by a real figure is written to stand without one.

---

## 1. Units awarded is a vanity metric. Here's the one that isn't.
*Tag: Franchise · ~4 min*
...
## 2. What actually happens in the first 100 days inside a founder-led portfolio company
*Tag: Private equity · ~4 min*
...
## 3. The five numbers a $20M business should look at weekly, and the twenty it shouldn't
*Tag: Systems · ~5 min*
...
## 4. Why most operating improvements don't survive the consultant leaving
*Tag: Operating · ~4 min*
...
## 5. Running an American business as an Australian, and the four things that don't translate
*Tag: Cross-border · ~4 min*
...
## 6. Four-wall EBITDA: the arithmetic most multi-unit operators aren't doing
*Tag: Multi-unit · ~5 min*
